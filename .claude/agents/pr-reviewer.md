...
- Commit/PR description explains _why_, not just _what_ — this is a low-traffic personal site, so scope creep and unrequested refactors are worth calling out.
